"""Approved stable contract registry for quality metrics.

High fan-in is healthy for small DTOs and explicit ports when the contract is
stable, documented, and intentionally shared. This registry keeps those cases
visible in raw metrics while preventing them from being treated as god modules.
"""
