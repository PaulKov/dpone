...
from dpone.adapters.native_generation_mssql_owner import _attempt_identity as _attempt_identity
from dpone.adapters.native_generation_mssql_owner import physical_owner as _physical_owner
