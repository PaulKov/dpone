"""Schema and read-contract helpers for MSSQL Parquet snapshots."""
...
def schema_blockers(schema: Sequence[tuple[str, str]]) -> list[str]:
    """Return unsupported MSSQL source-type blockers."""
...
def read_contract_options(request: ColumnarSnapshotRequest) -> dict[str, Any]:
    """Project the configured ClickHouse object-storage read authority."""
