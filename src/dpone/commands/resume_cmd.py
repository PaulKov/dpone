...
def register_parser(subparsers: argparse._SubParsersAction) -> argparse.ArgumentParser:
    parser = subparsers.add_parser("resume", help="Plan or execute resume from a failed idempotent stage")
    parser.add_argument("run_id")
    parser.add_argument("--from-stage", default="stage")
    parser.add_argument("--source-type", required=True)
    parser.add_argument("--sink-type", required=True)
    parser.add_argument("--strategy", required=True)
    parser.add_argument("--artifact-dir", default=".dpone/replay")
    parser.add_argument("--yes", action="store_true", help="Mark resume as approved for execution")
