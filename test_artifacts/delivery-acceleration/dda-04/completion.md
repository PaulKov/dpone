# DDA-04 completion and integration handoff
...
Reviewed producer correction and exact validation subject: `d8b09de644ab3bf72f9eee7b51cc8b8e38ca8a3c`.
Planning dependency (unchanged): `f3682940f8864563cde0e6b6ecee60f746b49020`.
...
All records below have unchanged identities on `d8b09de644ab3bf72f9eee7b51cc8b8e38ca8a3c`. `dirty: true`
...
| --- | --- | ---: | --- |
| producer | PASS | 4.305 | [producer.log](producer.log) |
| focused | PASS | 16.678 | [focused.log](focused.log) |
| contract | PASS | 3.326 | [contract.log](contract.log) |
| selection | PASS | 3.286 | [selection.log](selection.log) |
| ruff | PASS | 3.513 | [ruff.log](ruff.log) |
| format | PASS | 2.224 | [format.log](format.log) |
| mypy | PASS | 11.503 | [mypy.log](mypy.log) |
| mypy-component | PASS | 3.446 | [mypy-component.log](mypy-component.log) |
| imports | PASS | 25.178 | [imports.log](imports.log) |
| layers | FAIL | 23.066 | [layers.log](layers.log) |
| architecture | FAIL | 32.229 | [architecture.log](architecture.log) |
| module-size | PASS | 9.829 | [module-size.log](module-size.log) |
| pytest | FAIL | 1571.178 | [pytest.log](pytest.log) |
| docs | PASS | 19.381 | [docs.log](docs.log) |
| references | PASS | 21.783 | [references.log](references.log) |
| docs-language | PASS | 26.293 | [docs-language.log](docs-language.log) |
| mkdocs | PASS | 70.936 | [mkdocs.log](mkdocs.log) |
...
1. With planning dependency present, integrate reviewed commits in order using
   `cherry-pick -x`: `9795f01cb9a7ad01f404ce69e1356fa2aa32a399`, then `d8b09de644ab3bf72f9eee7b51cc8b8e38ca8a3c`,
