...
`examples/source-sink/clickhouse-to-clickhouse.yaml`; CI compares its parsed
YAML with this block.
...
4. Inspect the run artifact under `.dpone/runs/clickhouse_to_clickhouse`.
