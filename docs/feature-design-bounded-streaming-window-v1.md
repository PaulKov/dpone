...
See [ADR 0057](adr/0057-bounded-window-atomic-publication.md) and
...
### Integration with the current release line

The owner approved the final feature and integration over current master on
2026-09-09. The integration base is `698658b` (0.74.35), retaining 0.74.34 dbt
