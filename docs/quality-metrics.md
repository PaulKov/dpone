...
- Max: **4497** (`tests/test_airflow_self_service_cli.py`)
- Avg: **195.34**
- Median: **145**
...
- `dpone.readiness.managed_planning`: **21**
...
- `dpone.gitops.schema_contract_primitives`: **57**
- `dpone.commands.func_command`: **54**
- `dpone.runtime.sinks.load_result`: **52** - approved stable contract: sink load result DTO
...
- `dpone.runtime.deployment_cache_common`: **48**
...
- Layers observed: **58**
- Internal import edges: **9738**
- Intra-layer edges: **6825**
- Cross-layer edges: **2913**
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `dpone._compat` | 1 | 0 | 36 | 0 | 0 | 36 | 0.00 | 36.00 | 1.000 | 0 | 13 |
| `dpone.adapters` | 190 | 421 | 272 | 181 | 240 | 91 | 2.22 | 1.43 | 0.430 | 5 | 5 |
| `dpone.airflow` | 8 | 0 | 0 | 0 | 0 | 0 | 0.00 | 0.00 | 1.000 | 0 | 0 |
| `dpone.airflow_connection_names` | 1 | 0 | 9 | 0 | 0 | 9 | 0.00 | 9.00 | 1.000 | 0 | 3 |
...
| `dpone.manifest` | 123 | 381 | 548 | 314 | 67 | 234 | 3.10 | 4.46 | 0.824 | 7 | 13 |
...
| `dpone.ports` | 105 | 111 | 367 | 52 | 59 | 315 | 1.06 | 3.50 | 0.468 | 3 | 13 |
| `dpone.readiness` | 389 | 1052 | 877 | 639 | 413 | 238 | 2.70 | 2.25 | 0.607 | 21 | 7 |
| `dpone.root` | 1 | 1 | 0 | 0 | 1 | 0 | 1.00 | 0.00 | 0.000 | 1 | 0 |
| `dpone.runtime` | 1089 | 3249 | 2872 | 2659 | 590 | 213 | 2.98 | 2.64 | 0.818 | 17 | 10 |
...
| `dpone.readiness` | `dpone.manifest` | 101 |
| `dpone.commands` | `dpone.services` | 100 |
| `dpone.services` | `dpone.ports` | 100 |
| `dpone.readiness` | `dpone.runtime` | 93 |
| `dpone.readiness` | `dpone.contracts` | 90 |
| `dpone.commands` | `dpone.readiness` | 83 |
| `dpone.runtime` | `dpone.config` | 71 |
| `dpone.runtime` | `dpone.ports` | 69 |
...
| `dpone.runtime` | `dpone.readiness` | 56 |
