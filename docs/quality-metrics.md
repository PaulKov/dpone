...
- Layers observed: **58**
- Internal import edges: **9171**
- Intra-layer edges: **6415**
- Cross-layer edges: **2756**
- Intra-layer ratio: **0.699**
- Cross-layer ratio: **0.301**

- Excluded layers: **`dpone.compat`** (150 modules, 139 edges removed from this coarse architecture view)

**Heuristic interpretation**

- Intra-layer ratio = **0.699** → **OK** (higher means more dependencies stay within their own layer)
- Cross-layer ratio = **0.301** → **OK** (lower means cleaner boundaries between layers)
...
| `dpone.contracts` | 258 | 594 | 1342 | 583 | 11 | 759 | 2.30 | 5.20 | 0.981 | 5 | 18 |
...
| `dpone.manifest` | 120 | 369 | 527 | 306 | 63 | 221 | 3.08 | 4.39 | 0.829 | 7 | 13 |
...
| `dpone.ports` | 93 | 97 | 330 | 51 | 46 | 279 | 1.04 | 3.55 | 0.526 | 3 | 12 |
| `dpone.readiness` | 382 | 1014 | 862 | 628 | 386 | 234 | 2.65 | 2.26 | 0.619 | 21 | 7 |
| `dpone.root` | 1 | 1 | 0 | 0 | 1 | 0 | 1.00 | 0.00 | 0.000 | 1 | 0 |
| `dpone.runtime` | 1010 | 3016 | 2663 | 2460 | 556 | 203 | 2.99 | 2.64 | 0.816 | 17 | 10 |
...
| `dpone.readiness` | `dpone.contracts` | 83 |
...
| `dpone.ports` | `dpone.contracts` | 44 |
