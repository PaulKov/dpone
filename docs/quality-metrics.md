...
| `src/dpone/manifest/selection_models.py` | 419 |

### Coupling / Cohesion (internal imports inside `dpone.*`)

- Modules: **3571**
- Internal import edges: **9124**
- AVG Ce (fan-out): **2.56**
- Median Ce: **2**
- P90 Ce: **6**
- P95 Ce: **8**
...
- Avg clustering = **0.181** → **WARN** (higher clustering often means more cycles/tight coupling)
...
- `dpone.contracts.airflow_deployment`: **83**
...
- `dpone.config.load_strategy`: **43** - approved stable contract: load strategy enum contract

### Layer / Slice architecture metrics

- Layers observed: **58**
- Internal import edges: **8985**
- Intra-layer edges: **6290**
- Cross-layer edges: **2695**
...
| `dpone.adapters` | 152 | 280 | 191 | 104 | 176 | 87 | 1.84 | 1.26 | 0.371 | 5 | 5 |
...
| `dpone.app` | 22 | 174 | 30 | 14 | 160 | 16 | 7.91 | 1.36 | 0.080 | 10 | 4 |
...
| `dpone.manifest` | 115 | 348 | 503 | 299 | 49 | 204 | 3.03 | 4.37 | 0.859 | 7 | 13 |
...
| `dpone.ports` | 90 | 92 | 327 | 50 | 42 | 277 | 1.02 | 3.63 | 0.543 | 3 | 12 |
| `dpone.readiness` | 380 | 1017 | 858 | 625 | 392 | 233 | 2.68 | 2.26 | 0.615 | 21 | 7 |
| `dpone.root` | 1 | 1 | 0 | 0 | 1 | 0 | 1.00 | 0.00 | 0.000 | 1 | 0 |
| `dpone.runtime` | 992 | 2944 | 2606 | 2406 | 538 | 200 | 2.97 | 2.63 | 0.817 | 17 | 10 |
| `dpone.schema` | 1 | 1 | 1 | 0 | 1 | 1 | 1.00 | 1.00 | 0.000 | 1 | 1 |
| `dpone.security_redaction` | 1 | 0 | 27 | 0 | 0 | 27 | 0.00 | 27.00 | 1.000 | 0 | 9 |
| `dpone.services` | 324 | 906 | 540 | 356 | 550 | 184 | 2.80 | 1.67 | 0.393 | 20 | 9 |
...
|---|---|---:|
| `dpone.runtime` | `dpone.contracts` | 209 |
| `dpone.services` | `dpone.contracts` | 147 |
| `dpone.services` | `dpone.gitops` | 108 |
| `dpone.services` | `dpone.ports` | 101 |
| `dpone.adapters` | `dpone.ports` | 100 |
| `dpone.commands` | `dpone.services` | 100 |
| `dpone.readiness` | `dpone.contracts` | 92 |
| `dpone.readiness` | `dpone.manifest` | 90 |
| `dpone.readiness` | `dpone.runtime` | 86 |
| `dpone.commands` | `dpone.readiness` | 81 |
| `dpone.adapters` | `dpone.contracts` | 71 |
...
| `dpone.runtime` | `dpone.ports` | 46 |
| `dpone.ports` | `dpone.contracts` | 40 |
