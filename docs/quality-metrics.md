...
- Cohesion ratio (share of deps within slice): **0.612**
...
- Layers observed: **58**
- Internal import edges: **9076**
- Intra-layer edges: **6326**
- Cross-layer edges: **2750**
- Intra-layer ratio: **0.697**
- Cross-layer ratio: **0.303**

- Excluded layers: **`dpone.compat`** (150 modules, 139 edges removed from this coarse architecture view)

**Heuristic interpretation**

- Intra-layer ratio = **0.697** → **OK** (higher means more dependencies stay within their own layer)
- Cross-layer ratio = **0.303** → **OK** (lower means cleaner boundaries between layers)
...
| `dpone.contracts` | 248 | 560 | 1310 | 551 | 9 | 759 | 2.26 | 5.28 | 0.984 | 4 | 18 |
| `dpone.core` | 7 | 8 | 1 | 1 | 7 | 0 | 1.14 | 0.14 | 0.125 | 4 | 0 |
| `dpone.dag` | 40 | 107 | 115 | 72 | 35 | 43 | 2.67 | 2.88 | 0.673 | 5 | 6 |
| `dpone.gitops` | 201 | 506 | 591 | 418 | 88 | 173 | 2.52 | 2.94 | 0.826 | 10 | 6 |
...
| `dpone.manifest` | 118 | 375 | 522 | 307 | 68 | 215 | 3.18 | 4.42 | 0.819 | 8 | 13 |
...
|---|---|---:|
| `dpone.runtime` | `dpone.contracts` | 211 |
...
| `dpone.manifest` | `dpone.contracts` | 47 |
| `dpone.runtime` | `dpone.ports` | 46 |
| `dpone.ports` | `dpone.contracts` | 42 |
