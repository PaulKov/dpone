...
- `dpone.runtime.sinks.load_result`: **49** - approved stable contract: sink load result DTO
...
- Layers observed: **58**
- Internal import edges: **9533**
- Intra-layer edges: **6699**
- Cross-layer edges: **2834**
- Intra-layer ratio: **0.703**
- Cross-layer ratio: **0.297**

- Excluded layers: **`dpone.compat`** (150 modules, 139 edges removed from this coarse architecture view)

**Heuristic interpretation**

- Intra-layer ratio = **0.703** → **OK** (higher means more dependencies stay within their own layer)
- Cross-layer ratio = **0.297** → **OK** (lower means cleaner boundaries between layers)
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `dpone._compat` | 1 | 0 | 33 | 0 | 0 | 33 | 0.00 | 33.00 | 1.000 | 0 | 13 |
...
| `dpone.contracts` | 289 | 687 | 1488 | 675 | 12 | 813 | 2.38 | 5.15 | 0.983 | 6 | 18 |
...
| `dpone.ports` | 102 | 104 | 343 | 52 | 52 | 291 | 1.02 | 3.36 | 0.500 | 3 | 13 |
| `dpone.readiness` | 382 | 1011 | 864 | 629 | 382 | 235 | 2.65 | 2.26 | 0.622 | 21 | 7 |
| `dpone.root` | 1 | 1 | 0 | 0 | 1 | 0 | 1.00 | 0.00 | 0.000 | 1 | 0 |
| `dpone.runtime` | 1051 | 3133 | 2772 | 2569 | 564 | 203 | 2.98 | 2.64 | 0.820 | 17 | 10 |
