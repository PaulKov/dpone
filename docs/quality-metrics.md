...
- Cohesion ratio (share of deps within slice): **0.611**
...
- `dpone.contracts.airflow_deployment`: **86**
- `dpone.manifest.confined_files`: **79**
...
- Layers observed: **58**
- Internal import edges: **9083**
- Intra-layer edges: **6323**
- Cross-layer edges: **2760**
- Intra-layer ratio: **0.696**
- Cross-layer ratio: **0.304**

- Excluded layers: **`dpone.compat`** (150 modules, 139 edges removed from this coarse architecture view)

**Heuristic interpretation**

- Intra-layer ratio = **0.696** → **OK** (higher means more dependencies stay within their own layer)
- Cross-layer ratio = **0.304** → **OK** (lower means cleaner boundaries between layers)
...
| `dpone.manifest` | 119 | 382 | 523 | 307 | 75 | 216 | 3.21 | 4.39 | 0.804 | 8 | 13 |
...
| `dpone.ports` | 92 | 94 | 337 | 51 | 43 | 286 | 1.02 | 3.66 | 0.543 | 3 | 13 |
| `dpone.readiness` | 381 | 1021 | 862 | 627 | 394 | 235 | 2.68 | 2.26 | 0.614 | 21 | 7 |
| `dpone.root` | 1 | 1 | 0 | 0 | 1 | 0 | 1.00 | 0.00 | 0.000 | 1 | 0 |
| `dpone.runtime` | 990 | 2949 | 2606 | 2405 | 544 | 201 | 2.98 | 2.63 | 0.816 | 17 | 10 |
| `dpone.schema` | 1 | 1 | 1 | 0 | 1 | 1 | 1.00 | 1.00 | 0.000 | 1 | 1 |
| `dpone.security_redaction` | 1 | 0 | 27 | 0 | 0 | 27 | 0.00 | 27.00 | 1.000 | 0 | 9 |
| `dpone.services` | 325 | 918 | 542 | 356 | 562 | 186 | 2.82 | 1.67 | 0.388 | 20 | 9 |
...
|---|---|---:|
| `dpone.runtime` | `dpone.contracts` | 213 |
| `dpone.services` | `dpone.contracts` | 152 |
| `dpone.services` | `dpone.gitops` | 110 |
| `dpone.services` | `dpone.ports` | 104 |
| `dpone.adapters` | `dpone.ports` | 100 |
| `dpone.commands` | `dpone.services` | 100 |
| `dpone.readiness` | `dpone.manifest` | 92 |
| `dpone.readiness` | `dpone.contracts` | 91 |
...
| `dpone.manifest` | `dpone.contracts` | 51 |
| `dpone.runtime` | `dpone.ports` | 46 |
| `dpone.ports` | `dpone.contracts` | 41 |
