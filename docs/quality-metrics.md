...
- Avg clustering coefficient: **0.185**
...
- Avg clustering = **0.185** → **WARN** (higher clustering often means more cycles/tight coupling)
...
- Layers observed: **58**
- Internal import edges: **9429**
- Intra-layer edges: **6582**
- Cross-layer edges: **2847**
...
| `dpone.adapters` | 185 | 439 | 274 | 184 | 255 | 90 | 2.37 | 1.48 | 0.419 | 5 | 5 |
...
| `dpone.contracts` | 278 | 669 | 1480 | 658 | 11 | 822 | 2.41 | 5.32 | 0.984 | 5 | 18 |
...
|---|---|---:|
| `dpone.runtime` | `dpone.contracts` | 220 |
| `dpone.services` | `dpone.contracts` | 156 |
| `dpone.adapters` | `dpone.contracts` | 125 |
| `dpone.adapters` | `dpone.ports` | 125 |
