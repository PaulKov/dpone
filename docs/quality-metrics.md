...
| `src/dpone/contracts/native_originals.py` | 431 |
...
- Avg clustering coefficient: **0.183**
- Cohesion ratio (share of deps within slice): **0.619**

**Heuristic interpretation**

- AVG Ce = **2.59** → **OK** (lower is usually better; big fan-out hints 'god modules')
- P90 Ce = **6** → **OK** (if P90 grows, responsibilities are spreading)
- Avg clustering = **0.183** → **WARN** (higher clustering often means more cycles/tight coupling)
...
- Layers observed: **58**
- Internal import edges: **9575**
- Intra-layer edges: **6702**
- Cross-layer edges: **2873**
...
| `dpone.adapters` | 195 | 450 | 277 | 187 | 263 | 90 | 2.31 | 1.42 | 0.416 | 5 | 5 |
...
| `dpone.contracts` | 294 | 695 | 1524 | 683 | 12 | 841 | 2.36 | 5.18 | 0.983 | 6 | 18 |
...
|---|---|---:|
| `dpone.runtime` | `dpone.contracts` | 224 |
| `dpone.services` | `dpone.contracts` | 159 |
| `dpone.adapters` | `dpone.contracts` | 137 |
| `dpone.adapters` | `dpone.ports` | 121 |
