...
- Options:
  ...
  - `--registry-credentials-connection-id REGISTRY_CREDENTIALS_CONNECTION_ID` — Logical Airflow Connection id used only by runtime init-fetch
