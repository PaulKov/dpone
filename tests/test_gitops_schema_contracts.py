...
def test_gitops_schema_contract_catalog_is_public_and_documented() -> None:
    ...
    assert set(contracts) == {
        ...
        "release-set",
        "release-set-v2",
        "dbt-release-set-development-v1",
        "release-set-v3",
        "release-composition",
        "deployment-set",
        "deployment-set-v2",
        ...
        "airflow-deployment-index-v5",
        "airflow-deployment-index-v6",
        ...
        "airflow-runtime-init-fetch-plan-v4",
        "airflow-runtime-init-fetch-plan-v5",
        "airflow-runtime-init-fetch-plan-v6",
