"""Wide MySQL fixtures for mysql→ClickHouse pair-profile live certification."""
...
WIDE_TABLE = "mysql_to_clickhouse_wide"

# Shared MySQL DDL/seed with BQ/Postgres wide suites; blob included (hex→String on CH wire).
    ...
    for name, ddl, mysql_type, seed in _SPECS:
        ...
        columns.append(
            WideColumn(
                ...
                seed_sql=seed,
                expected_ch_type=decision.target_type,
            )
        )
    return columns
