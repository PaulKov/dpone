"""Wide MySQL fixtures for mysql→MSSQL pair-profile live certification."""
...
WIDE_TABLE = "mysql_to_mssql_wide"

# Shared MySQL DDL/seed with BQ/Postgres wide suites; expected types from MSSQL pair profile.
    ...
    for name, ddl, mysql_type, seed in _SPECS:
        ...
        columns.append(
            WideColumn(
                ...
                seed_sql=seed,
                expected_mssql_type=decision.target_type,
            )
        )
    return columns
