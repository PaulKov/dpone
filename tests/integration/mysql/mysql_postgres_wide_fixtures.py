"""Wide MySQL fixtures for mysql→Postgres pair-profile live certification."""
...
WIDE_TABLE = "mysql_to_postgres_wide"

# Shared MySQL DDL/seed with BQ wide suite; expected types from postgres pair profile.
    ...
    for name, ddl, mysql_type, seed in _SPECS:
        ...
        columns.append(
            WideColumn(
                ...
                seed_sql=seed,
                expected_pg_type=decision.target_type,
            )
        )
    return columns
