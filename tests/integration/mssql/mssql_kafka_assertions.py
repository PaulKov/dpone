"""Assertions for mssql→Kafka wide live certification (JSON message payloads)."""
...
def assert_typed_spot_checks(
    ...
    *,
    ...
    assert row["c_varbinary"], "varbinary column should round-trip as non-empty CSV/JSON wire value"
