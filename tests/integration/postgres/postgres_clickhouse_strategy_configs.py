"""LoadConfig builders for postgres→ClickHouse strategy live certification."""
...
from tests.integration.postgres.postgres_clickhouse_wide_fixtures import SOURCE_SCHEMA, WIDE_TABLE
...
def _base(
    ...
    **kwargs,
    ...
    return LoadConfig(
        ...
        # Tab-delimited wire accepted by ClickHouse bulk (see CLICKHOUSE_TSV_ARTIFACT_FORMATS).
