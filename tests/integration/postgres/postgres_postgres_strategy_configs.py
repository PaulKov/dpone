"""LoadConfig builders for postgres→postgres strategy live certification."""
...
from tests.integration.postgres.postgres_postgres_wide_fixtures import SOURCE_SCHEMA, WIDE_TABLE
