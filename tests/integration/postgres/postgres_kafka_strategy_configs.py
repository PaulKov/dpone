"""LoadConfig builders for postgres→Kafka strategy live certification.
...
from tests.integration.postgres.postgres_kafka_wide_fixtures import SOURCE_SCHEMA, WIDE_TABLE
